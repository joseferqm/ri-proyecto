...
function handleError(jqXHR, textStatus, error) { // The 1st is the JQuery XHR object. The 2nd is the text status of the error. The 3rd is the error itself.
    console.log(error);
}
...
$(document).ready(() => {
    table = new Tabulator("#results-table", {
        ...
        columns: [
            {title: "", field: "index", width: 40}, //incrementing row number
            {title: "Direccion web", field: "url", formatter: "link", formatterParams: {target: "_blank",}},
            {title: "En cache", field: "local", formatter: "link", formatterParams: {target: "_blank",}},
        ],
    });
